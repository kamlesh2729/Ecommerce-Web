...
const TrendingItems = () => {
  ...
  return (
    ...
    {ProudProduct.map((product) => {
        ...
        <div
            key={id}
            className="cursor-pointer border-2 border-gray-400 hover:border-slate-500 rounded-md items-center"
        >
            <Link>
            <div>
                <img src={image} alt="product images" className=" h-[200px] w-[21rem]"/>
            </div>
